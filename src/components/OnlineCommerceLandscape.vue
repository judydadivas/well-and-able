...
<script>
import image from '../assets/img34.png'
import HousesVue from './Houses.vue'
export default {
  name: 'OnlineCommerceLandscape',
  components: {
    house: HousesVue
  },
  data () {
    return {
      ...
      totalArea: [
        ...
        {
          label: '36 sq.m. - 45 sq.m.',
          value: 'area3'
        },
        {
          label: '46 sq.m. - 54 sq.m.',
          value: 'area4'
        },
        {
          label: '55 sq.m. - 72 sq.m.',
          value: 'area5'
        },
        {
          label: '73 sq.m. - 90 sq.m.',
          value: 'area6'
        },
        {
          label: '> 90 sq.m.',
      ...
      cost: [
        ...
        {
          label: '5001 USD - 7000 USD',
          value: 'cost3'
        },
        {
          label: '7001 USD - 9000 USD',
          value: 'cost4'
        },
        {
          label: '9001 USD - 15000 USD',
          value: 'cost5'
        },
        {
          label: '> 15000 U',
